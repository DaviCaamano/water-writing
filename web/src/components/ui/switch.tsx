  ...
  return (
    <SwitchPrimitive.Root
      ...
      className={cn(
        ...
        'data-[state=checked]:bg-temp data-[state=unchecked]:bg-temp',
        'dark:data-[state=unchecked]:bg-temp/80',
    ...
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          'pointer-events-none block rounded-full bg-temp ring-0 transition-transform',
          'group-data-[size=default]/switch:size-4 group-data-[size=sm]/switch:size-3',
          cn('group-data-[size=default]/switch:data-[state=checked]:translate-x-[calc(100%-2px)]'),
          'group-data-[size=sm]/switch:data-[state=checked]:translate-x-[calc(100%-2px)]',
          'dark:data-[state=checked]:bg-temp',
          ...
          'dark:data-[state=unchecked]:bg-temp',
        )}
      />
    </SwitchPrimitive.Root>
  );
