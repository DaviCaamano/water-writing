    ...
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          ...
          'data-[state=closed]:animate-out data-[state=closed]:overflow-hidden',
...
function DropdownMenuLabel({
  ...
  return (
    <DropdownMenuPrimitive.Label
      ...
      data-inset={inset}
      className={cn(
        'px-1.5 py-1 text-xs font-medium text-card-foreground data-[inset]:pl-7',
        className,
      )}
      {...props}
    />
...
function DropdownMenuShortcut({ className, ...props }: React.ComponentProps<'span'>) {
  return (
    <span
      ...
      className={cn(
        'ml-auto text-xs tracking-widest text-card-foreground group-focus/dropdown-menu-item:text-card-foreground',
        className,
      )}
      {...props}
    />
